...
- `gemini-2.5-flash-image` → 用于**图像生成**（支持 generateContent API）✅
...
## 最近修改
- ✅ 2024-01-04: 更新 Google Gemini 图像生成模型从 `gemini-2.0-flash` 改为 `gemini-2.5-flash-image`（修复 404 错误）
